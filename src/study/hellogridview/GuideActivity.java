...
public class GuideActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pageViews.add(inflater.inflate(R.layout.viewpager_page6, null));
        pageViews.add(inflater.inflate(R.layout.viewpager_page7, null));
        pageViews.add(inflater.inflate(R.layout.viewpager_page8, null));
