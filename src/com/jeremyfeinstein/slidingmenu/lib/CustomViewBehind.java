...
public class CustomViewBehind extends ViewGroup {
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		if (mSecondaryContent != null)
			mSecondaryContent.layout(0, 0, width-mRightWidthOffset/*mWidthOffset*/, height);
	}
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (mSecondaryContent != null) {
			final int contentWidth2 = getChildMeasureSpec(widthMeasureSpec, 0, width-mRightWidthOffset/*mWidthOffset*/);
	...
	public int getMenuLeft(View content, int page) {
		if (mMode == SlidingMenu.LEFT) {
			...
			case 0:
				return content.getLeft();
			case 2:
				return content.getLeft() + getRightBehindWidth();/*getBehindWidth();*/	
			}
		} else if (mMode == SlidingMenu.LEFT_RIGHT) {
			switch (page) {
			case 0:
